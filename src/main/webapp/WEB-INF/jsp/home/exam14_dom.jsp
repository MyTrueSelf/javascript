	...
	<head>
		...
		<script type="text/javascript">
			...
			function fun2() {
				...
				class1 = document.querySelectorAll(".class1")
			...
			function fun4() {
				...
				div2.innerHTML = "<img src='${pageContext.request.contextPath}/resource/img/bg01.jpg'/>"
			}
			
			function fun5(){
				// var mid = document.loginForm.mid.value // 고전 방법. 여긴 name이 loginForm이여서 찾는 것.
				var mid = document.querySelector("#loginForm #mid").value; //id를 두번 찾아 들어감. loginForm이란 id를 찾고, 거기서 다시 mid를 id로 찾음.
		...
		<div style="margin-bottom:20px;padding:10px;border-top:1; border:1px solid black">
			...
			<div>
				<form id= "loginForm" name ="loginForm" action="main.do" onsubmit="return fun5()">
					...
					<button style="margin-bottom:10px" >사용자가 입력한 값 검사2</button>		
				</form>
			</div>
		</div>
