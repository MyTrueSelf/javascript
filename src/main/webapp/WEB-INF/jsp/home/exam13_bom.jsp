...
<html>
	<head>
		...
		<script>
			...
			function fun2() {
				myWindow = window.open("https://www.w3schools.com", "", "width=200,height=100");
			}
			
			function fun3() {
				myWindow.close("https://www.w3schools.com");
			}
	...
	<body>
		...
		<ul>
			<li><a href = javascript:fun1()>창 크기</a></li>
			...
			<li><a href = javascript:fun6()>다른데로 가보자</a></li>
